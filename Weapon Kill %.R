...
#### Making this a function that can be read and invoked in the app ----
# note: probably remove the "initial values" when using with app
calcEff <- function(hr1=c(2,8), hr2=c(3,6), am1=0, am2=0, ea=c(1,20)){
  h1  <- mean(hr1)
  h2  <- mean(hr2)
